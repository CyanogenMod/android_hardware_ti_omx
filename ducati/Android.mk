...
TI_SYSTEMOMX_TOP := hardware/ti/omx/ducati/system-omx

TI_OMX_CFLAGS := -Wall -fpic -pipe -DSTATIC_TABLE -O0

#call build domx infrastructure
include $(TI_SYSTEMOMX_TOP)/system/mm_osal/src/Android.mk
include $(TI_SYSTEMOMX_TOP)/system/omx_core/src/Android.mk
