...
int G723d_fdwrite = 0, G723d_fdread = 0;
int errno;
#endif
...
OMX_ERRORTYPE OMX_ComponentInit (OMX_HANDLETYPE hComp)
{
    ...
    OMX_AUDIO_PARAM_PCMMODETYPE  *G723_op = NULL;
    OMX_AUDIO_PARAM_G723TYPE *G723_ip = NULL;
    G723DEC_COMPONENT_PRIVATE *pComponentPrivate = NULL;
    G723D_AUDIODEC_PORT_TYPE *pCompPort = NULL;
    G723D_BUFFERLIST *pTemp = NULL;
    int i=0;

    G723DEC_DPRINT ("Entering OMX_ComponentInit\n");

    G723D_OMX_CONF_CHECK_CMD(pHandle,1,1)
    ...
    G723D_OMX_MALLOC(pHandle->pComponentPrivate,G723DEC_COMPONENT_PRIVATE);

    pComponentPrivate = pHandle->pComponentPrivate;
    pComponentPrivate->pHandle = pHandle;

    G723D_OMX_MALLOC(pCompPort, G723D_AUDIODEC_PORT_TYPE);
    pComponentPrivate->pCompPort[G723D_INPUT_PORT] =  pCompPort;

    G723D_OMX_MALLOC(pCompPort, G723D_AUDIODEC_PORT_TYPE);
    pComponentPrivate->pCompPort[G723D_OUTPUT_PORT] = pCompPort;
    G723D_OMX_MALLOC(pTemp, G723D_BUFFERLIST);
    ...
    G723D_OMX_MALLOC(pComponentPrivate->sPortParam, OMX_PORT_PARAM_TYPE);
    OMX_CONF_INIT_STRUCT(pComponentPrivate->sPortParam, OMX_PORT_PARAM_TYPE);
    G723D_OMX_MALLOC(pComponentPrivate->pPriorityMgmt, OMX_PRIORITYMGMTTYPE);
    ...
    pComponentPrivate->G723Params = NULL;
    pComponentPrivate->PcmParams = NULL;

    G723D_OMX_MALLOC(G723_ip, OMX_AUDIO_PARAM_G723TYPE);
    G723D_OMX_MALLOC(G723_op, OMX_AUDIO_PARAM_PCMMODETYPE);

    pComponentPrivate->G723Params = G723_ip;
    pComponentPrivate->PcmParams = G723_op;
    ...
    G723D_OMX_MALLOC_SIZE(pComponentPrivate->sDeviceString,(100*sizeof(OMX_STRING)),OMX_STRING);
    ...
    G723D_OMX_MALLOC(pPortDef_ip, OMX_PARAM_PORTDEFINITIONTYPE);
    G723D_OMX_MALLOC(pPortDef_op, OMX_PARAM_PORTDEFINITIONTYPE);

    pComponentPrivate->pPortDef[G723D_INPUT_PORT] = pPortDef_ip;
    pComponentPrivate->pPortDef[G723D_OUTPUT_PORT] = pPortDef_op;

    /* Set input port defaults */
    pPortDef_ip->nSize                                  = sizeof (OMX_PARAM_PORTDEFINITIONTYPE);
    pPortDef_ip->nPortIndex                         = G723D_INPUT_PORT;
    pPortDef_ip->eDir                               = OMX_DirInput;
    pPortDef_ip->nBufferCountActual                 = G723D_NUM_INPUT_BUFFERS;
    pPortDef_ip->nBufferCountMin                    = G723D_NUM_INPUT_BUFFERS;
    pPortDef_ip->nBufferSize                        = G723D_INPUT_BUFFER_SIZE;
    pPortDef_ip->bEnabled                           = OMX_TRUE;
    pPortDef_ip->bPopulated                         = OMX_FALSE;
    pPortDef_ip->eDomain                            = OMX_PortDomainAudio;
    pPortDef_ip->format.audio.eEncoding             = OMX_AUDIO_CodingG723;
    ...
    pPortDef_op->nPortIndex                         = G723D_OUTPUT_PORT;
    pPortDef_op->eDir                               = OMX_DirOutput;
    pPortDef_op->nBufferCountMin                    = G723D_NUM_OUTPUT_BUFFERS;
    pPortDef_op->nBufferCountActual                 = G723D_NUM_OUTPUT_BUFFERS;
    pPortDef_op->nBufferSize                        = G723D_OUTPUT_BUFFER_SIZE;
    ...
    G723D_OMX_MALLOC(pComponentPrivate->pCompPort[G723D_INPUT_PORT]->pPortFormat, 
                    OMX_AUDIO_PARAM_PORTFORMATTYPE);
    G723D_OMX_MALLOC(pComponentPrivate->pCompPort[G723D_OUTPUT_PORT]->pPortFormat, 
                    OMX_AUDIO_PARAM_PORTFORMATTYPE);
    OMX_CONF_INIT_STRUCT(pComponentPrivate->pCompPort[G723D_INPUT_PORT]->pPortFormat, 
                    OMX_AUDIO_PARAM_PORTFORMATTYPE);
    OMX_CONF_INIT_STRUCT(pComponentPrivate->pCompPort[G723D_OUTPUT_PORT]->pPortFormat, 
                    OMX_AUDIO_PARAM_PORTFORMATTYPE);


    /* Set input port format defaults */
    pPortFormat = pComponentPrivate->pCompPort[G723D_INPUT_PORT]->pPortFormat;
    OMX_CONF_INIT_STRUCT(pPortFormat, OMX_AUDIO_PARAM_PORTFORMATTYPE);
    pPortFormat->nPortIndex         = G723D_INPUT_PORT;
    pPortFormat->nIndex             = OMX_IndexParamAudioPcm;
    pPortFormat->eEncoding          = OMX_AUDIO_CodingPCM;

    /* Set output port format defaults */
    pPortFormat = pComponentPrivate->pCompPort[G723D_OUTPUT_PORT]->pPortFormat;
    OMX_CONF_INIT_STRUCT(pPortFormat, OMX_AUDIO_PARAM_PORTFORMATTYPE);
    pPortFormat->nPortIndex         = G723D_OUTPUT_PORT;
    pPortFormat->nIndex             = OMX_IndexParamAudioPcm;
    pPortFormat->eEncoding          = OMX_AUDIO_CodingPCM;

    /* Set input port parameters */
    OMX_CONF_INIT_STRUCT(G723_ip, OMX_AUDIO_PARAM_G723TYPE);
    G723_ip->nPortIndex               = G723D_INPUT_PORT;
    G723_ip->nSize                    = sizeof(OMX_AUDIO_PARAM_G723TYPE);
    G723_ip->nVersion.s.nVersionMajor = 1;
    G723_ip->nVersion.s.nVersionMinor = 1;
    G723_ip->nChannels                = 1; /* mono */
    G723_ip->eBitRate            = 6300;
    G723_ip->bDTX = OMX_FALSE;
    G723_ip->bHiPassFilter = OMX_FALSE;
    G723_ip->bPostFilter = OMX_FALSE;
    

    /* Set output port parameters */
    OMX_CONF_INIT_STRUCT(G723_op, OMX_AUDIO_PARAM_PCMMODETYPE);
    G723_op->nPortIndex               = G723D_OUTPUT_PORT;
    G723_op->nSamplingRate            = 16000;
    G723_op->nChannels                = OMX_AUDIO_ChannelModeMono;
    G723_op->nSize                    = sizeof(OMX_AUDIO_PARAM_PCMMODETYPE);
    G723_op->nVersion.s.nVersionMajor = 0x1;
    G723_op->nVersion.s.nVersionMinor = 0x1;
    G723_op->nBitPerSample            = 16;
    G723_op->eNumData                 = OMX_NumericalDataUnsigned;
    G723_op->eEndian                  = OMX_EndianLittle;
    G723_op->bInterleaved             = OMX_FALSE;
    G723_op->ePCMMode                 = OMX_AUDIO_PCMModeLinear;

    pComponentPrivate->bBufferIsAllocated = 1;
    pComponentPrivate->bPortDefsAllocated = 1;

#ifdef DSP_RENDERING_ON
    if((G723d_fdwrite=open(FIFO1,O_WRONLY))<0) {
        G723DEC_EPRINT("[G723 Component] - failure to open WRITE pipe\n");
        eError = OMX_ErrorHardware;
    }
    if((G723d_fdread=open(FIFO2,O_RDONLY))<0) {
        G723DEC_EPRINT("[G723 Component] - failure to open READ pipe\n");
        eError = OMX_ErrorHardware;
    }
#endif
    ...
    if (eError != OMX_ErrorNone) {
        G723DEC_DPRINT ("Error returned from loading ResourceManagerProxy thread\n");
        goto EXIT;
    }
#endif

    eError = G723Dec_StartCompThread(pHandle);
    if (eError != OMX_ErrorNone) {
        G723DEC_EPRINT ("Error returned from the Component\n");
        goto EXIT;
    }

EXIT:
    if(OMX_ErrorNone != eError) {
        G723DEC_EPRINT(":: ************* ERROR: Freeing Other Malloced Resources\n");
        G723D_OMX_FREE(pPortDef_ip);
        G723D_OMX_FREE(pPortDef_op);
        G723D_OMX_FREE(G723_ip);
        G723D_OMX_FREE(G723_op);
        G723D_OMX_FREE(pTemp);
    }
    G723DEC_DPRINT ("Exiting OMX_ComponentInit\n");
    return eError;
}
...
*
* @param G723dData This is command data that came with command.
*
* @pre          OMX_Init should be called by application.
*
* @post         None
                                  ...
                                  OMX_U32 nParam,OMX_PTR pCmdData)
{
    ...
    G723DEC_DPRINT("G723DEC: Entered SendCommand\n");
    if(pCompPrivate->curState == OMX_StateInvalid){
        G723DEC_DPRINT("G723DEC: Error Notofication Sent to App\n");
#if 0
        pCompPrivate->cbInfo.EventHandler (pHandle, 
                                ...
                                "Invalid State");
#endif
        G723D_OMX_ERROR_EXIT(eError, OMX_ErrorInvalidState,"OMX_ErrorInvalidState");
    }

    switch(Cmd) {
    case OMX_CommandStateSet:
        G723DEC_DPRINT("G723DEC: Entered switch - Command State Set\n");
        if (nParam == OMX_StateLoaded) {
            pCompPrivate->bLoadedCommandPending = OMX_TRUE;
        }
        if(pCompPrivate->curState == OMX_StateLoaded) {
            G723DEC_DPRINT("G723DEC: Entered switch - curState == OMX_StateLoaded\n");
            if((nParam == OMX_StateExecuting) || (nParam == OMX_StatePause)) {
                G723DEC_DPRINT("G723DEC: Entered switch - nParam == StatExecuting \
|| OMX_StatePause\n");
                pCompPrivate->cbInfo.EventHandler (pHandle,
                                                   pHandle->pApplicationPrivate,
                                                   OMX_EventError,
                                                   ...
                                                   0,
                                                   NULL);
                G723DEC_DPRINT("Incorrect St Tr fm Loaded to Executing By App\n");
                goto EXIT;
            }
            if(nParam == OMX_StateInvalid) {
                ...
                pCompPrivate->cbInfo.EventHandler (pHandle,
                                                   ...
                                                   0,
                                                   NULL);
                G723DEC_DPRINT("Incorrect State Tr from Loaded to Invalid by Application\n");
                goto EXIT;
            }
        }
        break;
    case OMX_CommandFlush:
        G723DEC_DPRINT("G723DEC: Entered switch - Command Flush\n");
        if(nParam > 1 && nParam != -1) {
            G723D_OMX_ERROR_EXIT(eError,OMX_ErrorBadPortIndex,"OMX_ErrorBadPortIndex");
        }
        break;
    case OMX_CommandPortDisable:
        break;
    case OMX_CommandPortEnable:
        G723DEC_DPRINT("G723DEC: Entered switch - Command Port Enable/Disbale\n");
        break;
    case OMX_CommandMarkBuffer:
        G723DEC_DPRINT("G723DEC: Entered switch - Command Mark Buffer\n");
        ...
        break;
    default:
        G723DEC_DPRINT("G723DEC: Command Received Default error\n");
    ...
    if (nRet == -1) {
        G723D_OMX_ERROR_EXIT(eError,OMX_ErrorHardware,"write failed: OMX_ErrorHardware");
    }
    ...
    if(Cmd == OMX_CommandStateSet && nParam == OMX_StateExecuting){
        if(pCompPrivate->acdnmode == 1) {
            ...
            if((write(G723d_fdwrite, &cmd_data, sizeof(cmd_data)))<0)
                G723DEC_DPRINT("[G723 decoder] - fail to send command to audio manager\n");
                                   ...
                                   OMX_PTR ComponentParameterStructure)
{
    ...
    G723DEC_DPRINT("Inside the GetParameter:: %x\n",nParamIndex);

    G723D_OMX_CONF_CHECK_CMD(hComp,1,1);
    pComponentPrivate = (G723DEC_COMPONENT_PRIVATE *)(((OMX_COMPONENTTYPE*)hComp)->pComponentPrivate);

    G723D_OMX_CONF_CHECK_CMD(pComponentPrivate, ComponentParameterStructure, 1);
    pParameterStructure = (OMX_PARAM_PORTDEFINITIONTYPE*)ComponentParameterStructure;

    G723DEC_DPRINT(":: Entering the GetParameter\n");
    ...
    case OMX_IndexParamAudioInit:
        G723DEC_DPRINT(":: GetParameter OMX_IndexParamAudioInit\n");
        memcpy(ComponentParameterStructure, pComponentPrivate->sPortParam, sizeof(OMX_PORT_PARAM_TYPE));
        break;

    case OMX_IndexParamPortDefinition:
        G723DEC_DPRINT(": GetParameter OMX_IndexParamPortDefinition \n");
        if(((OMX_PARAM_PORTDEFINITIONTYPE *)(ComponentParameterStructure))->nPortIndex ==
           pComponentPrivate->pPortDef[G723D_INPUT_PORT]->nPortIndex) {
            memcpy(ComponentParameterStructure, pComponentPrivate->pPortDef[G723D_INPUT_PORT], 
                   sizeof(OMX_PARAM_PORTDEFINITIONTYPE));
        } else if(((OMX_PARAM_PORTDEFINITIONTYPE *)(ComponentParameterStructure))->nPortIndex ==
                  pComponentPrivate->pPortDef[G723D_OUTPUT_PORT]->nPortIndex) {
            memcpy(ComponentParameterStructure, pComponentPrivate->pPortDef[G723D_OUTPUT_PORT], 
                   sizeof(OMX_PARAM_PORTDEFINITIONTYPE));
        } else {
            G723DEC_DPRINT(":: OMX_ErrorBadPortIndex from GetParameter \n");
            eError = OMX_ErrorBadPortIndex;
        }
        break;

    case OMX_IndexParamAudioPortFormat:
        G723DEC_DPRINT(":: GetParameter OMX_IndexParamAudioPortFormat \n");
        if(((OMX_AUDIO_PARAM_PORTFORMATTYPE *)(ComponentParameterStructure))->nPortIndex ==
           pComponentPrivate->pPortDef[G723D_INPUT_PORT]->nPortIndex) {
            if(((OMX_AUDIO_PARAM_PORTFORMATTYPE *)(ComponentParameterStructure))->nIndex >
               pComponentPrivate->pCompPort[G723D_INPUT_PORT]->pPortFormat->nPortIndex) {
                eError = OMX_ErrorNoMore;
            }
            else {
                memcpy(ComponentParameterStructure, pComponentPrivate->pCompPort[G723D_INPUT_PORT]->pPortFormat, 
                ...
                pComponentPrivate->pPortDef[G723D_OUTPUT_PORT]->nPortIndex){
            if(((OMX_AUDIO_PARAM_PORTFORMATTYPE *)(ComponentParameterStructure))->nIndex >
               pComponentPrivate->pCompPort[G723D_OUTPUT_PORT]->pPortFormat->nPortIndex) {
                eError = OMX_ErrorNoMore;
            }
            else {
                memcpy(ComponentParameterStructure, pComponentPrivate->pCompPort[G723D_OUTPUT_PORT]->pPortFormat, 
                       sizeof(OMX_AUDIO_PARAM_PORTFORMATTYPE));
            }
        }
        else {
    ...
    case OMX_IndexParamAudioPcm:
        G723DEC_DPRINT(" :: GetParameter OMX_IndexParamAudioPcm \n");
        if(((OMX_AUDIO_PARAM_G723TYPE *)(ComponentParameterStructure))->nPortIndex ==
           pComponentPrivate->G723Params->nPortIndex) {
            memcpy(ComponentParameterStructure, pComponentPrivate->G723Params, 
    ...
    case OMX_IndexParamPriorityMgmt:
        G723DEC_DPRINT(" :: GetParameter OMX_IndexParamPriorityMgmt \n");
    ...
    default:
        G723DEC_DPRINT(" :: OMX_ErrorUnsupportedIndex GetParameter \n");
        eError = OMX_ErrorUnsupportedIndex;
        break;
    }
EXIT:
    G723DEC_DPRINT(" :: Exiting GetParameter\n");
    G723DEC_DPRINT(" :: Returning = 0x%x\n",eError);
    return eError;
}
        ...
        OMX_IN  OMX_PTR pCompParam)
{
    ...
    OMX_AUDIO_PARAM_G723TYPE *pCompG723Param = NULL;
    OMX_PARAM_COMPONENTROLETYPE  *pRole = NULL;
    OMX_PARAM_BUFFERSUPPLIERTYPE sBufferSupplier;

    G723D_OMX_CONF_CHECK_CMD(hComponent,1,1)

    pComponentPrivate = (G723DEC_COMPONENT_PRIVATE *)(((OMX_COMPONENTTYPE*)hComponent)->pComponentPrivate);
    G723D_OMX_CONF_CHECK_CMD(pComponentPrivate, pCompParam, 1);


    G723DEC_DPRINT(" :: Entering the SetParameter\n");
    if (pComponentPrivate->curState != OMX_StateLoaded) {
        eError = OMX_ErrorIncorrectStateOperation;
        G723DEC_DPRINT(" :: OMX_ErrorIncorrectStateOperation from SetParameter");
        goto EXIT;
    }

    switch(nIndex) {
    case OMX_IndexParamAudioPortFormat:
        G723DEC_DPRINT(":: SetParameter OMX_IndexParamAudioPortFormat \n");
        pComponentParam = (OMX_AUDIO_PARAM_PORTFORMATTYPE *)pCompParam;
        if ( pComponentParam->nPortIndex == pComponentPrivate->pCompPort[G723D_INPUT_PORT]->pPortFormat->nPortIndex ) {
            memcpy(pComponentPrivate->pCompPort[G723D_INPUT_PORT]->pPortFormat, 
                   pComponentParam, sizeof(OMX_AUDIO_PARAM_PORTFORMATTYPE));
        } else if ( pComponentParam->nPortIndex == pComponentPrivate->pCompPort[G723D_OUTPUT_PORT]->pPortFormat->nPortIndex ) {
            memcpy(pComponentPrivate->pCompPort[G723D_OUTPUT_PORT]->pPortFormat, 
                   pComponentParam, sizeof(OMX_AUDIO_PARAM_PORTFORMATTYPE));
        } else {
            G723DEC_DPRINT(":: OMX_ErrorBadPortIndex from SetParameter");
            eError = OMX_ErrorBadPortIndex;
        }
        break;

    case OMX_IndexParamAudioPcm:
        G723DEC_DPRINT(" :: SetParameter OMX_IndexParamAudioPcm \n");
...
#if 0
        if(pCompG723Param->nSamplingRate == INVALID_SAMPLING_FREQ) {
            eError = OMX_ErrorUnsupportedIndex;
            G723DEC_EPRINT("Unsupported SampleRate Given By the App\n");
            goto EXIT;
        }
#endif

        if (pCompPcmParam->nPortIndex == G723D_OUTPUT_PORT) { /* means Output port */
            memcpy(((G723DEC_COMPONENT_PRIVATE *)
...
case OMX_IndexParamAudioG723:
        G723DEC_DPRINT(" :: SetParameter OMX_IndexParamAudioPcm \n");
        pCompG723Param = (OMX_AUDIO_PARAM_G723TYPE *)pCompParam;

        if(pCompG723Param->nPortIndex == G723D_INPUT_PORT) { /* means Input port */
            memcpy(((G723DEC_COMPONENT_PRIVATE*)
                    pHandle->pComponentPrivate)->G723Params, pCompG723Param, 
                   sizeof(OMX_AUDIO_PARAM_G723TYPE));
        }
        else {
            G723DEC_DPRINT(":: OMX_ErrorBadPortIndex from SetParameter");
...
/********/
    ...
    case OMX_IndexParamPortDefinition:
        ...
        if (pComponentParamPort->nPortIndex == 0) {
            if (pComponentParamPort->eDir != OMX_DirInput) {
                G723DEC_DPRINT(":: Invalid input buffer Direction\n");
                eError = OMX_ErrorBadParameter;
                goto EXIT;
            }
            if (pComponentParamPort->format.audio.eEncoding != OMX_AUDIO_CodingG723) {
                G723DEC_DPRINT(":: Invalid format Parameter\n");
                eError = OMX_ErrorBadParameter;
                goto EXIT;
            }
        } else if (pComponentParamPort->nPortIndex == 1) {
            if (pComponentParamPort->eDir != OMX_DirOutput) {
                G723DEC_DPRINT(" :: Invalid Output buffer Direction\n");
                eError = OMX_ErrorBadParameter;
                goto EXIT;
            }
        ...
        G723DEC_DPRINT(":: SetParameter OMX_IndexParamPortDefinition \n");
        if(((OMX_PARAM_PORTDEFINITIONTYPE *)(pCompParam))->nPortIndex ==
           pComponentPrivate->pPortDef[G723D_INPUT_PORT]->nPortIndex) {
            G723DEC_DPRINT(":: SetParameter OMX_IndexParamPortDefinition input \n");
            memcpy(pComponentPrivate->pPortDef[G723D_INPUT_PORT], pCompParam,
                   sizeof(OMX_PARAM_PORTDEFINITIONTYPE));
        }
        else if(((OMX_PARAM_PORTDEFINITIONTYPE *)(pCompParam))->nPortIndex ==
                pComponentPrivate->pPortDef[G723D_OUTPUT_PORT]->nPortIndex) {
            G723DEC_DPRINT(":: SetParameter OMX_IndexParamPortDefinition output\n");
            memcpy(pComponentPrivate->pPortDef[G723D_OUTPUT_PORT], pCompParam, 
                   sizeof(OMX_PARAM_PORTDEFINITIONTYPE));
        }
        else {
            G723DEC_DPRINT(":: OMX_ErrorBadPortIndex from SetParameter");
    ...
    case OMX_IndexParamPriorityMgmt:
        G723DEC_DPRINT(":: SetParameter OMX_IndexParamPriorityMgmt \n");
        memcpy(pComponentPrivate->pPriorityMgmt, (OMX_PRIORITYMGMTTYPE*)pCompParam, 
               sizeof(OMX_PRIORITYMGMTTYPE));
        break;

    case OMX_IndexParamAudioInit:
        G723DEC_DPRINT(":: SetParameter OMX_IndexParamAudioInit \n");
    ...
    case OMX_IndexParamCompBufferSupplier:
        if(((OMX_PARAM_PORTDEFINITIONTYPE *)(pCompParam))->nPortIndex ==
           pComponentPrivate->pPortDef[G723D_INPUT_PORT]->nPortIndex) {
            G723DEC_DPRINT(":: SetParameter OMX_IndexParamCompBufferSupplier \n");
    ...
    default:
        G723DEC_DPRINT(":: SetParameter OMX_ErrorUnsupportedIndex \n");
        eError = OMX_ErrorUnsupportedIndex;
        break;
    }
     
EXIT:
    G723DEC_DPRINT(":: Exiting SetParameter\n");
    G723DEC_DPRINT(":: Returning = 0x%x\n",eError);
    return eError;
                                   ...
                                   OMX_PTR pAppData)
{
    ...
    pComponentPrivate = (G723DEC_COMPONENT_PRIVATE *)pHandle->pComponentPrivate;
    G723D_OMX_CONF_CHECK_CMD(pComponentPrivate,1,1)

    G723DEC_DPRINT ("Entering SetCallbacks\n");

    G723D_OMX_CONF_CHECK_CMD(pCallBacks, pCallBacks->EventHandler, pCallBacks->EmptyBufferDone)
    G723D_OMX_CONF_CHECK_CMD(pCallBacks->FillBufferDone, 1, 1)
...
EXIT:
    G723DEC_DPRINT ("Exiting SetCallbacks\n");
    return eError;
}
                                        ...
                                        OMX_UUIDTYPE* pComponentUUID)
{
    ...
    if(pComponentVersion != NULL && pComponentName != NULL) {
        ...
        G723DEC_DPRINT("%d :: OMX_ErrorBadParameter from GetComponentVersion",__LINE__);
        eError = OMX_ErrorBadParameter;
    }
...
{
    OMX_ERRORTYPE eError = OMX_ErrorNone;
    G723DEC_DPRINT ("Entering GetConfig\n");
    G723DEC_DPRINT ("Inside   GetConfig\n");
    G723DEC_DPRINT ("Exiting  GetConfig\n");
    return eError;
}
                                ...
                                OMX_PTR ComponentConfigStructure)
{
    ...
    G723DEC_DPRINT ("Entering SetConfig\n");

    G723D_OMX_CONF_CHECK_CMD(hComp,ComponentConfigStructure,1)
    ...
    G723D_OMX_CONF_CHECK_CMD(pComponentPrivate,1,1)
        ...
        switch (nConfigIndex){
        case OMX_IndexCustomG723DecHeaderInfoConfig:
        ...
        case OMX_IndexConfigAudioMute:
            ...
            G723DEC_DPRINT("Set Mute/Unmute for playback stream\n");
            cmd_data.hComponent = hComp;
            if(pMuteStructure->bMute == OMX_TRUE){
                G723DEC_DPRINT("Mute the playback stream\n");
                cmd_data.AM_Cmd = AM_CommandStreamMute;
            }
            else{
                G723DEC_DPRINT("unMute the playback stream\n");
        ...
        case OMX_IndexConfigAudioVolume:
            ...
            G723DEC_DPRINT("Set volume for playback stream\n");
            cmd_data.hComponent = hComp;
        ...
        case  OMX_IndexCustomG723DecDataPath:
    ...
    G723DEC_DPRINT ("Exiting  SetConfig\n");
EXIT:
...
static OMX_ERRORTYPE GetState (OMX_HANDLETYPE pComponent, OMX_STATETYPE* pState)
{
    ...
    if (!pState) {
        G723DEC_DPRINT (":: About to exit with bad parameter\n");
        eError = OMX_ErrorBadParameter;
        goto EXIT;
    }
    ...
    if (pHandle && pHandle->pComponentPrivate) {
        *pState =  ((G723DEC_COMPONENT_PRIVATE*)
                                      ...
                                      OMX_BUFFERHEADERTYPE* pBuffer)
{
    ...
    pPortDef = ((G723DEC_COMPONENT_PRIVATE*)
                    pComponentPrivate)->pPortDef[G723D_INPUT_PORT];

    if(!pPortDef->bEnabled) {
        G723D_OMX_ERROR_EXIT(eError,OMX_ErrorIncorrectStateOperation,
                             "OMX_ErrorIncorrectStateOperation");
    }

    if (pBuffer == NULL) {
        G723D_OMX_ERROR_EXIT(eError,OMX_ErrorBadParameter,"OMX_ErrorBadParameter");
    }

    if (pBuffer->nSize != sizeof(OMX_BUFFERHEADERTYPE)) {
        G723DEC_EPRINT(":: Error: Bad Size = %ld, Add: %p\n",
                                       pBuffer->nSize,pBuffer);
        G723D_OMX_ERROR_EXIT(eError,OMX_ErrorBadParameter,"Bad Size");
    } 

    if (pBuffer->nInputPortIndex != G723D_INPUT_PORT) {
        G723D_OMX_ERROR_EXIT(eError,OMX_ErrorBadPortIndex,"OMX_ErrorBadPortIndex");
    }


    if (pBuffer->nVersion.nVersion != pComponentPrivate->nVersion) {
        G723D_OMX_ERROR_EXIT(eError,OMX_ErrorVersionMismatch,"OMX_ErrorVersionMismatch");
    }
    ...
    G723DEC_DPRINT("\n------------------------------------------\n\n");
    G723DEC_DPRINT (":: Component Sending Filled ip buff %p \
                             to Component Thread\n",pBuffer);
    G723DEC_DPRINT("\n------------------------------------------\n\n");
...
EXIT:
    G723DEC_DPRINT (":: Exiting EmptyThisBuffer, eError = %d\n",eError);
    return eError;
}
                                     ...
                                     OMX_BUFFERHEADERTYPE* pBuffer)
{
    ...
    G723DEC_DPRINT("\n------------------------------------------\n\n");
    G723DEC_DPRINT (" :: Component Sending Emptied op buff %p \
                             to Component Thread\n",pBuffer);
    G723DEC_DPRINT("\n------------------------------------------\n\n");
    ...
    pPortDef = ((G723DEC_COMPONENT_PRIVATE*)
                    pComponentPrivate)->pPortDef[G723D_OUTPUT_PORT];
    ...
    if (pBuffer->nOutputPortIndex != G723D_OUTPUT_PORT) {
        G723D_OMX_ERROR_EXIT(eError,OMX_ErrorBadPortIndex,"OMX_ErrorBadPortIndex");
    }

    G723DEC_DPRINT("::pBuffer->nVersion.nVersion:%ld\n",pBuffer->nVersion.nVersion);
    G723DEC_DPRINT("::pComponentPrivate->nVersion:%ld\n",pComponentPrivate->nVersion);
    if (pBuffer->nVersion.nVersion != pComponentPrivate->nVersion) {
        G723D_OMX_ERROR_EXIT(eError,OMX_ErrorVersionMismatch,"OMX_ErrorVersionMismatch");
    }
    ...
    if(pComponentPrivate->pMarkBuf){
        G723DEC_DPRINT("FillThisBuffer Line\n");
...
EXIT:
    G723DEC_DPRINT (":: Exiting FillThisBuffer\n");
    return eError;
}
...
static OMX_ERRORTYPE ComponentDeInit(OMX_HANDLETYPE pHandle)
{
    ...
    G723DEC_DPRINT("ComponentDeInit\n");
    G723D_OMX_CONF_CHECK_CMD(pComponent,1,1)
    pComponentPrivate = (G723DEC_COMPONENT_PRIVATE *)pComponent->pComponentPrivate;
    G723D_OMX_CONF_CHECK_CMD(pComponentPrivate,1,1)
    ...
    if (eError != OMX_ErrorNone) {
        G723DEC_EPRINT ("%d ::Error returned from destroy ResourceManagerProxy thread\n",
                       __LINE__);
    }

    eError1 = RMProxy_Deinitalize();
    if (eError1 != OMX_ErrorNone) {
        G723DEC_EPRINT(":: First Error in ComponentDeinit: From RMProxy_Deinitalize\n");
        eError = eError1;
    }

    /*eError = RMProxy_SendCommand(pHandle, RMProxy_FreeResource, 
                                 OMX_G723_Decoder_COMPONENT, 0, NULL);
    if (eError != OMX_ErrorNone) {
        G723DEC_EPRINT ("%d ::Error returned from destroy ResourceManagerProxy thread\n",
                       __LINE__);
    }
    ...
    if(0 != pthreadError) {
        G723DEC_EPRINT(":: First Error in ComponentDeinit: From pthread_join\n");
        eError = OMX_ErrorHardware;
        goto EXIT;
    }
    ...
    if (OMX_ErrorNone != threadError && OMX_ErrorNone != eError) {
        ...
        G723DEC_EPRINT("%d :: Error while closing Component Thread\n",__LINE__);
        goto EXIT;
    }

    eError1 = G723DEC_FreeCompResources(pHandle);
    if (OMX_ErrorNone != eError1) {
        if (OMX_ErrorNone == eError) {
            G723DEC_EPRINT(":: First Error in ComponentDeinit: From FreeCompResources\n");
            eError = eError1;
        }
    }

    if (pComponentPrivate->sDeviceString != NULL) {
        G723D_OMX_FREE(pComponentPrivate->sDeviceString);
    }

    G723DEC_MEMPRINT(":: Freeing: pComponentPrivate = %p\n", pComponentPrivate);
    G723D_OMX_FREE(pComponentPrivate);
    G723DEC_DPRINT("::*********** ComponentDeinit is Done************** \n");
...
{
    OMX_ERRORTYPE eError = OMX_ErrorNone;
    G723DEC_DPRINT (":: Entering ComponentTunnelRequest\n");
    G723DEC_DPRINT (":: Inside   ComponentTunnelRequest\n");
    eError = OMX_ErrorNotImplemented;
    G723DEC_DPRINT (":: Exiting ComponentTunnelRequest\n");
    return eError;
}
                   ...
                   OMX_IN OMX_U32 nSizeBytes)
{
    ...
    G723DEC_DPRINT (":: Entering AllocateBuffer\n");
    G723D_OMX_CONF_CHECK_CMD(hComponent,1,1)
    pComponentPrivate = (G723DEC_COMPONENT_PRIVATE *)
    ...
    G723D_OMX_CONF_CHECK_CMD(pPortDef, 1, 1)
    ...
    G723D_OMX_MALLOC(pBufferHeader, OMX_BUFFERHEADERTYPE);

    /* Needed for cache synchronization between ARM and DSP */
    G723D_OMX_MALLOC_SIZE(pBufferHeader->pBuffer,(nSizeBytes + 256),OMX_U8);
    pBufferHeader->pBuffer += 128;
    pBufferHeader->nVersion.nVersion = G723DEC_BUFHEADER_VERSION;


    G723DEC_DPRINT("********************************************\n");
    G723DEC_DPRINT(":: Allocated BufHeader %p Buffer = %p, on port %ld\n",
                      pBufferHeader,
                      pBufferHeader->pBuffer, nPortIndex);

    G723DEC_DPRINT(":: Ip Num = %ld\n",pComponentPrivate->pInputBufferList->numBuffers);
    G723DEC_DPRINT(":: Op Num = %ld\n",pComponentPrivate->pOutputBufferList->numBuffers);
    G723DEC_DPRINT("********************************************\n");
    ...
    if (nPortIndex == G723D_INPUT_PORT) {
        ...
        G723DEC_DPRINT("pComponentPrivate->pInputBufferList->pBufHdr[%ld] = %p\n",
        pComponentPrivate->pInputBufferList->numBuffers,
    ...
    } else if (nPortIndex == G723D_OUTPUT_PORT) {
        ...
        G723DEC_DPRINT("pComponentPrivate->pOutputBufferList->pBufHdr[%ld] = %p\n",
            pComponentPrivate->pOutputBufferList->numBuffers,
    ...
    pBufferHeader->nVersion.s.nVersionMajor = G723DEC_MAJOR_VER;
    pBufferHeader->nVersion.s.nVersionMinor = G723DEC_MINOR_VER;
    ...
    *pBuffer = pBufferHeader;
    ...
    G723DEC_DPRINT(":: A Buffer has been alloced\n");

EXIT:
    if(OMX_ErrorNone != eError) {
        G723DEC_DPRINT("%d :: ************* ERROR: Freeing Other Malloced Resources\n",__LINE__);
        G723D_OMX_FREE(pBufferHeader->pBuffer);
        G723D_OMX_FREE(pBufferHeader);
    }
            ...
            OMX_IN  OMX_BUFFERHEADERTYPE* pBuffer)
{
    ...
    G723DEC_DPRINT ("Entering FreeBuffer\n");
    ...
    for (i=0; i < MAX_NUM_OF_BUFS; i++) {
        ...
        if (buff == (OMX_U8 *)pBuffer) {
            G723DEC_DPRINT("Found matching input buffer\n");
            G723DEC_DPRINT("buff = %p\n",buff);
            G723DEC_DPRINT("pBuffer = %p\n",pBuffer);
            inputIndex = i;
            break;
        }else{
            G723DEC_DPRINT("%d:: No matching found for pBuffer %p\n",__LINE__,pBuffer);
        }
    }
    ...
    for (i=0; i < MAX_NUM_OF_BUFS; i++) {
        ...
        if (buff == (OMX_U8 *)pBuffer) {
            G723DEC_DPRINT("Found matching output buffer\n");
            G723DEC_DPRINT("buff = %p\n",buff);
            G723DEC_DPRINT("pBuffer = %p\n",pBuffer);
            outputIndex = i;
            break;
    ...
    if (inputIndex != -1) {
        ...
        G723DEC_MEMPRINT("Freeing: %p IP Buf Header\n\n",
                  pComponentPrivate->pInputBufferList->pBufHdr[inputIndex]);

        G723D_OMX_FREE(pComponentPrivate->pInputBufferList->pBufHdr[inputIndex]);
        pComponentPrivate->pInputBufferList->numBuffers--;

        if (pComponentPrivate->pInputBufferList->numBuffers <
                        pComponentPrivate->pPortDef[G723D_INPUT_PORT]->nBufferCountMin) {
            pComponentPrivate->pPortDef[G723D_INPUT_PORT]->bPopulated = OMX_FALSE;
        }
        if(pComponentPrivate->pPortDef[G723D_INPUT_PORT]->bEnabled &&
        ...
        if (pComponentPrivate->pOutputBufferList->bufferOwner[outputIndex] == 1) {
            ...
            G723DEC_MEMPRINT("Freeing: %p OP Buffer\n",buff);
            G723D_OMX_FREE(buff);
        }

        G723DEC_MEMPRINT("Freeing: %p OP Buf Header\n\n",
               pComponentPrivate->pOutputBufferList->pBufHdr[outputIndex]);

        G723D_OMX_FREE(pComponentPrivate->pOutputBufferList->pBufHdr[outputIndex]);
        pComponentPrivate->pOutputBufferList->numBuffers--;

        G723DEC_DPRINT("pComponentPrivate->pOutputBufferList->numBuffers = %ld\n",
                        pComponentPrivate->pOutputBufferList->numBuffers);
        G723DEC_DPRINT("pComponentPrivate->pPortDef[G723D_OUTPUT_PORT]->nBufferCountMin = %ld\n",
                        pComponentPrivate->pPortDef[G723D_OUTPUT_PORT]->nBufferCountMin);

        if (pComponentPrivate->pOutputBufferList->numBuffers <
            pComponentPrivate->pPortDef[G723D_OUTPUT_PORT]->nBufferCountMin) {
            pComponentPrivate->pPortDef[G723D_OUTPUT_PORT]->bPopulated = OMX_FALSE;
        }

        if(pComponentPrivate->pPortDef[G723D_OUTPUT_PORT]->bEnabled &&
            pComponentPrivate->bLoadedCommandPending == OMX_FALSE &&
                (pComponentPrivate->curState == OMX_StateIdle ||
                pComponentPrivate->curState == OMX_StateExecuting ||
                pComponentPrivate->curState == OMX_StatePause)) {
        ...
        G723DEC_DPRINT("Returning OMX_ErrorBadParameter\n");
        eError = OMX_ErrorBadParameter;
    }
    ...
    G723DEC_DPRINT ("Exiting FreeBuffer\n");
    return eError;
}
            ...
            OMX_IN OMX_U8* pBuffer)
{
    ...
    G723DEC_DPRINT ("Entering UseBuffer\n");
    G723DEC_DPRINT ("pBuffer = %p\n",pBuffer);
    ...
    pPortDef = ((G723DEC_COMPONENT_PRIVATE*)
                    pComponentPrivate)->pPortDef[nPortIndex];
    G723DEC_DPRINT ("pPortDef = %p\n", pPortDef);
    G723DEC_DPRINT ("pPortDef->bEnabled = %d\n",pPortDef->bEnabled);
    ...
    if (nPortIndex == G723D_OUTPUT_PORT) {
        pBufferHeader->nInputPortIndex = -1;
        pBufferHeader->nOutputPortIndex = nPortIndex;
            ...
            OMX_OUT OMX_INDEXTYPE* pIndexType)
{
    ...
    G723DEC_DPRINT("GetExtensionIndex\n");
    if (!(strcmp(cParameterName,"OMX.TI.index.config.g723headerinfo"))) {
        *pIndexType = OMX_IndexCustomG723DecHeaderInfoConfig;
        G723DEC_DPRINT("OMX_IndexCustomG723DecHeaderInfoConfig\n");
    }
    else if(!(strcmp(cParameterName,"OMX.TI.index.config.g723decstreamIDinfo"))){
                *pIndexType = OMX_IndexCustomG723DecStreamIDConfig;
        G723DEC_DPRINT("OMX_IndexCustomG723DecStreamIDConfig\n");
    }
    else if(!(strcmp(cParameterName,"OMX.TI.index.config.g723dec.datapath"))) {
                *pIndexType = OMX_IndexCustomG723DecDataPath;
        G723DEC_DPRINT("OMX_IndexCustomG723DecDataPath\n");
    } 
    else {
        eError = OMX_ErrorBadParameter;
    }

    G723DEC_DPRINT("Exiting GetExtensionIndex\n");
    return eError;
}
