...
OMX_ERRORTYPE OMX_ComponentInit (OMX_HANDLETYPE hComp)
{
    ...
    OMX_AUDIO_PARAM_G723TYPE *G723_1_op = NULL;
    OMX_AUDIO_PARAM_G723TYPE *G723_1_ip = NULL;
    OMX_ERRORTYPE eError = OMX_ErrorNone;
    OMX_COMPONENTTYPE *pHandle = (OMX_COMPONENTTYPE*) hComp;
    G723_1ENC_PORT_TYPE *pCompPort = NULL;
    OMX_AUDIO_PARAM_PORTFORMATTYPE *pPortFormat = NULL;
    int i = 0;

    G723_1ENC_DPRINT("%d :: Entering OMX_ComponentInit\n", __LINE__);
    ...
    OMX_NBMALLOC_STRUCT(pHandle->pComponentPrivate, G723_1ENC_COMPONENT_PRIVATE);
    memset(pHandle->pComponentPrivate, 0x0, sizeof(G723_1ENC_COMPONENT_PRIVATE));

    ((G723_1ENC_COMPONENT_PRIVATE *)pHandle->pComponentPrivate)->pHandle = pHandle;
    pComponentPrivate = pHandle->pComponentPrivate;

    OMX_NBMALLOC_STRUCT(pCompPort, G723_1ENC_PORT_TYPE);
    pComponentPrivate->pCompPort[G723_1ENC_INPUT_PORT] = pCompPort;

    OMX_NBMALLOC_STRUCT(pCompPort, G723_1ENC_PORT_TYPE);
    pComponentPrivate->pCompPort[G723_1ENC_OUTPUT_PORT] = pCompPort;
    ...
    OMX_NBMALLOC_STRUCT(G723_1_op, OMX_AUDIO_PARAM_G723TYPE);
    OMX_NBCONF_INIT_STRUCT(G723_1_op, OMX_AUDIO_PARAM_G723TYPE);
    pComponentPrivate->G723_1Params[G723_1ENC_OUTPUT_PORT] = G723_1_op;
    G723_1_op->nPortIndex = G723_1ENC_OUTPUT_PORT;

    OMX_NBMALLOC_STRUCT(G723_1_ip, OMX_AUDIO_PARAM_G723TYPE);
    OMX_NBCONF_INIT_STRUCT(G723_1_ip, OMX_AUDIO_PARAM_G723TYPE);
    pComponentPrivate->G723_1Params[G723_1ENC_INPUT_PORT] = G723_1_ip;
    G723_1_ip->nPortIndex = G723_1ENC_INPUT_PORT;

    /* malloc and initialize number of input buffers */
    OMX_NBMALLOC_STRUCT(pComponentPrivate->pInputBufferList, G723_1ENC_BUFFERLIST);
    pComponentPrivate->pInputBufferList->numBuffers = 0;

    /* malloc and initialize number of output buffers */
    OMX_NBMALLOC_STRUCT(pComponentPrivate->pOutputBufferList, G723_1ENC_BUFFERLIST);
    pComponentPrivate->pOutputBufferList->numBuffers = 0;

    for (i=0; i < G723_1ENC_MAX_NUM_OF_BUFS; i++) {
    ...
    pComponentPrivate->pPortDef[G723_1ENC_INPUT_PORT] = pPortDef_ip;

    pPortDef_ip->nPortIndex                         = G723_1ENC_INPUT_PORT;
    pPortDef_ip->eDir                               = OMX_DirInput;
    pPortDef_ip->nBufferCountActual                 = G723_1ENC_NUM_INPUT_BUFFERS;
    pPortDef_ip->nBufferCountMin                    = G723_1ENC_NUM_INPUT_BUFFERS;
    pPortDef_ip->nBufferSize                        = G723_1ENC_INPUT_BUFFER_SIZE_DASF;
    ...
    pComponentPrivate->pPortDef[G723_1ENC_OUTPUT_PORT] = pPortDef_op;

    pPortDef_op->nPortIndex                         = G723_1ENC_OUTPUT_PORT;
    pPortDef_op->eDir                               = OMX_DirOutput;
    pPortDef_op->nBufferCountMin                    = G723_1ENC_NUM_OUTPUT_BUFFERS;
    pPortDef_op->nBufferCountActual                 = G723_1ENC_NUM_OUTPUT_BUFFERS;
    pPortDef_op->nBufferSize                        = G723_1ENC_OUTPUT_BUFFER_SIZE;
    pPortDef_op->bEnabled                           = OMX_TRUE;
    pPortDef_op->bPopulated                         = OMX_FALSE;
    pPortDef_op->eDomain                            = OMX_PortDomainAudio;
    pPortDef_op->format.audio.eEncoding             = OMX_AUDIO_CodingG723;
    pPortDef_op->format.audio.pNativeRender         = NULL;
    pPortDef_op->format.audio.bFlagErrorConcealment = OMX_FALSE;

    OMX_NBMALLOC_STRUCT(pComponentPrivate->pCompPort[G723_1ENC_INPUT_PORT]->pPortFormat, OMX_AUDIO_PARAM_PORTFORMATTYPE);
    OMX_NBCONF_INIT_STRUCT(pComponentPrivate->pCompPort[G723_1ENC_INPUT_PORT]->pPortFormat, OMX_AUDIO_PARAM_PORTFORMATTYPE);
    /* Set input port format defaults */
    pPortFormat = pComponentPrivate->pCompPort[G723_1ENC_INPUT_PORT]->pPortFormat;
    OMX_NBCONF_INIT_STRUCT(pPortFormat, OMX_AUDIO_PARAM_PORTFORMATTYPE);
    pPortFormat->nPortIndex         = G723_1ENC_INPUT_PORT;
    pPortFormat->nIndex             = OMX_IndexParamAudioPcm;
    pPortFormat->eEncoding          = OMX_AUDIO_CodingPCM;

    OMX_NBMALLOC_STRUCT(pComponentPrivate->pCompPort[G723_1ENC_OUTPUT_PORT]->pPortFormat, OMX_AUDIO_PARAM_PORTFORMATTYPE);
    OMX_NBCONF_INIT_STRUCT(pComponentPrivate->pCompPort[G723_1ENC_OUTPUT_PORT]->pPortFormat, OMX_AUDIO_PARAM_PORTFORMATTYPE);
    /* Set output port format defaults */
    pPortFormat = pComponentPrivate->pCompPort[G723_1ENC_OUTPUT_PORT]->pPortFormat;
    OMX_NBCONF_INIT_STRUCT(pPortFormat, OMX_AUDIO_PARAM_PORTFORMATTYPE);
    pPortFormat->nPortIndex         = G723_1ENC_OUTPUT_PORT;
    pPortFormat->nIndex             = OMX_IndexParamAudioPcm;
    pPortFormat->eEncoding          = OMX_AUDIO_CodingG723;

    G723_1ENC_DPRINT("%d :: Setting dasf & acdn and MultiFrame modes to 0\n",__LINE__);
    ...
    pComponentPrivate->G723_1FrameSize[0] = 24;
    pComponentPrivate->G723_1FrameSize[1] = 20;
    pComponentPrivate->G723_1FrameSize[2] = 4;
    pComponentPrivate->G723_1FrameSize[3] = 1;
    pComponentPrivate->lastOutBufArrived = NULL;
    pComponentPrivate->LastBufSent = 0;
    pComponentPrivate->bPreempted = OMX_FALSE; 

    strcpy((char*)pComponentPrivate->componentRole.cRole, "audio_encoder.g723_1"); 
    ...
    eError = G723_1ENC_StartComponentThread(pHandle);
    G723_1ENC_DPRINT("%d :: OMX_ComponentInit\n", __LINE__);
    if (eError != OMX_ErrorNone) {
      G723_1ENC_DPRINT("%d :: Error returned from the Component\n",__LINE__);
      goto EXIT;
    }
    ...
    G723_1ENC_DPRINT("%d :: OMX_ComponentInit\n", __LINE__);
    if (eError != OMX_ErrorNone) {
        G723_1ENC_DPRINT("%d :: Error returned from loading ResourceManagerProxy thread\n",__LINE__);
        goto EXIT;
    }
#endif

EXIT:
    G723_1ENC_DPRINT("%d :: Exiting OMX_ComponentInit\n", __LINE__);
                                   ...
                                   OMX_PTR pAppData)
{
    ...
    G723_1ENC_DPRINT("%d :: Entering SetCallbacks\n", __LINE__);
    if (pCallBacks == NULL) {
        eError = OMX_ErrorBadParameter;
        G723_1ENC_DPRINT("%d :: Received the empty callbacks from the application\n",__LINE__);
        goto EXIT;
    }
...
EXIT:
    G723_1ENC_DPRINT("%d :: Exiting SetCallbacks\n", __LINE__);
    G723_1ENC_DPRINT("%d :: Returning = 0x%x\n",__LINE__,eError);
    return eError;
}
                                          ...
                                          OMX_UUIDTYPE* pComponentUUID)
{
    ...
    OMX_COMPONENTTYPE *pHandle = (OMX_COMPONENTTYPE*) hComp;
    G723_1ENC_COMPONENT_PRIVATE *pComponentPrivate = (G723_1ENC_COMPONENT_PRIVATE *) pHandle->pComponentPrivate;
    G723_1ENC_DPRINT("%d :: Entering GetComponentVersion\n", __LINE__);
    ...
    if(pComponentVersion != NULL && pComponentName != NULL) {
        ...
        G723_1ENC_DPRINT("%d :: OMX_ErrorBadParameter from GetComponentVersion",__LINE__);
        eError = OMX_ErrorBadParameter;
    }

    G723_1ENC_DPRINT("%d :: Exiting GetComponentVersion\n", __LINE__);
    G723_1ENC_DPRINT("%d :: Returning = 0x%x\n",__LINE__,eError);
    return eError;
}
/*-------------------------------------------------------------------*/
                                  ...
                                  OMX_PTR pCmdData)
{
    ...
    G723_1ENC_COMPONENT_PRIVATE *pCompPrivate =
             (G723_1ENC_COMPONENT_PRIVATE *)pHandle->pComponentPrivate;
    int nRet = 0;
    G723_1ENC_DPRINT("%d :: Entering SendCommand()\n", __LINE__);
    if(pCompPrivate->curState == OMX_StateInvalid) {
        eError = OMX_ErrorInvalidState;
        G723_1ENC_DPRINT("%d :: Error OMX_ErrorInvalidState Sent to App\n",__LINE__);
        goto EXIT;
    }

    switch(Cmd) {
        case OMX_CommandStateSet:
            G723_1ENC_DPRINT("%d :: OMX_CommandStateSet SendCommand\n",__LINE__);
        ...
        case OMX_CommandFlush:
            G723_1ENC_DPRINT("%d :: OMX_CommandFlush SendCommand\n",__LINE__);
            if(nParam > 1 && nParam != -1) {
                eError = OMX_ErrorBadPortIndex;
                G723_1ENC_DPRINT("%d :: OMX_ErrorBadPortIndex from SendCommand",__LINE__);
                goto EXIT;
            }
            break;
        case OMX_CommandPortDisable:
            G723_1ENC_DPRINT("%d :: OMX_CommandPortDisable SendCommand\n",__LINE__);
            break;
        case OMX_CommandPortEnable:
            G723_1ENC_DPRINT("%d :: OMX_CommandPortEnable SendCommand\n",__LINE__);
            break;
        case OMX_CommandMarkBuffer:
            G723_1ENC_DPRINT("%d :: OMX_CommandMarkBuffer SendCommand\n",__LINE__);
            if (nParam > 0) {
                eError = OMX_ErrorBadPortIndex;
                G723_1ENC_DPRINT("%d :: OMX_ErrorBadPortIndex from SendCommand",__LINE__);
                goto EXIT;
            ...
            break;
        default:
            G723_1ENC_DPRINT("%d :: Command Received Default eError\n",__LINE__);
            pCompPrivate->cbInfo.EventHandler ( pHandle,
                                                pHandle->pApplicationPrivate,
                                                OMX_EventError,
                                                OMX_ErrorUndefined,
    ...
    if (nRet == -1) {
       ...
       G723_1ENC_DPRINT("%d :: OMX_ErrorInsufficientResources from SendCommand",__LINE__);
       goto EXIT;
    }
...
EXIT:
    G723_1ENC_DPRINT("%d :: Exiting SendCommand()\n", __LINE__);
    G723_1ENC_DPRINT("%d :: Returning = 0x%x\n",__LINE__,eError);
    return eError;
}
/*-------------------------------------------------------------------*/
                                   ...
                                   OMX_PTR ComponentParameterStructure)
{
    ...
    pComponentPrivate = (G723_1ENC_COMPONENT_PRIVATE *)(((OMX_COMPONENTTYPE*)hComp)->pComponentPrivate);
    pParameterStructure = (OMX_PARAM_PORTDEFINITIONTYPE*)ComponentParameterStructure;
    G723_1ENC_DPRINT("%d :: Entering the GetParameter\n",__LINE__);
    if (pParameterStructure == NULL) {
        eError = OMX_ErrorBadParameter;
        G723_1ENC_DPRINT("%d :: OMX_ErrorBadPortIndex from GetParameter",__LINE__);
        goto EXIT;
    }

    if(pComponentPrivate->curState == OMX_StateInvalid) {
        eError = OMX_ErrorIncorrectStateOperation;
        G723_1ENC_DPRINT("%d :: OMX_ErrorIncorrectStateOperation from GetParameter",__LINE__);
        goto EXIT;
    }

    switch(nParamIndex){
        case OMX_IndexParamAudioInit:
            G723_1ENC_DPRINT("%d :: GetParameter OMX_IndexParamAudioInit \n",__LINE__);
            memcpy(ComponentParameterStructure, pComponentPrivate->sPortParam, sizeof(OMX_PORT_PARAM_TYPE));
            break;

        case OMX_IndexParamPortDefinition:
            G723_1ENC_DPRINT("%d :: GetParameter OMX_IndexParamPortDefinition \n",__LINE__);
            if(((OMX_PARAM_PORTDEFINITIONTYPE *)(ComponentParameterStructure))->nPortIndex ==
                pComponentPrivate->pPortDef[G723_1ENC_INPUT_PORT]->nPortIndex) {
                    memcpy(ComponentParameterStructure, pComponentPrivate->pPortDef[G723_1ENC_INPUT_PORT], sizeof(OMX_PARAM_PORTDEFINITIONTYPE)); 
            }
            else if(((OMX_PARAM_PORTDEFINITIONTYPE *)(ComponentParameterStructure))->nPortIndex ==
                                      pComponentPrivate->pPortDef[G723_1ENC_OUTPUT_PORT]->nPortIndex) {
                memcpy(ComponentParameterStructure, pComponentPrivate->pPortDef[G723_1ENC_OUTPUT_PORT], sizeof(OMX_PARAM_PORTDEFINITIONTYPE));
            } 
            else {
                G723_1ENC_DPRINT("%d :: OMX_ErrorBadPortIndex from GetParameter \n",__LINE__);
                eError = OMX_ErrorBadPortIndex;
            }
            break;

        case OMX_IndexParamAudioPortFormat:
            G723_1ENC_DPRINT("%d :: GetParameter OMX_IndexParamAudioPortFormat \n",__LINE__);
            if(((OMX_AUDIO_PARAM_PORTFORMATTYPE *)(ComponentParameterStructure))->nPortIndex ==
                pComponentPrivate->pPortDef[G723_1ENC_INPUT_PORT]->nPortIndex) {
                    if(((OMX_AUDIO_PARAM_PORTFORMATTYPE *)(ComponentParameterStructure))->nIndex >
                      pComponentPrivate->pCompPort[G723_1ENC_INPUT_PORT]->pPortFormat->nPortIndex) {
                        eError = OMX_ErrorNoMore;
                    }
                    else {
                        memcpy(ComponentParameterStructure, pComponentPrivate->pCompPort[G723_1ENC_INPUT_PORT]->pPortFormat, sizeof(OMX_AUDIO_PARAM_PORTFORMATTYPE));
                    }
                }
                else if(((OMX_AUDIO_PARAM_PORTFORMATTYPE *)(ComponentParameterStructure))->nPortIndex ==
                            pComponentPrivate->pPortDef[G723_1ENC_OUTPUT_PORT]->nPortIndex){
                    if(((OMX_AUDIO_PARAM_PORTFORMATTYPE *)(ComponentParameterStructure))->nIndex >
                                                 pComponentPrivate->pCompPort[G723_1ENC_OUTPUT_PORT]->pPortFormat->nPortIndex) {
                        eError = OMX_ErrorNoMore;
                    }
                    else {
                        memcpy(ComponentParameterStructure, pComponentPrivate->pCompPort[G723_1ENC_OUTPUT_PORT]->pPortFormat, sizeof(OMX_AUDIO_PARAM_PORTFORMATTYPE));
                    }
                }
                else {
                    G723_1ENC_DPRINT("%d :: OMX_ErrorBadPortIndex from GetParameter \n",__LINE__);
        ...
        case OMX_IndexParamAudioPcm:
            G723_1ENC_DPRINT("%d :: GetParameter OMX_IndexParamAudioG723_1 \n",__LINE__);
            if(((OMX_AUDIO_PARAM_PCMMODETYPE *)(ComponentParameterStructure))->nPortIndex ==
                        pComponentPrivate->G723_1Params[G723_1ENC_OUTPUT_PORT]->nPortIndex) {
                memcpy(ComponentParameterStructure, pComponentPrivate->G723_1Params[G723_1ENC_OUTPUT_PORT], sizeof(OMX_AUDIO_PARAM_PCMMODETYPE));
        ...
        case OMX_IndexParamPriorityMgmt:
            G723_1ENC_DPRINT("%d :: GetParameter OMX_IndexParamPriorityMgmt \n",__LINE__);
        ...
        default:
            G723_1ENC_DPRINT("%d :: OMX_ErrorUnsupportedIndex GetParameter \n",__LINE__);
            eError = OMX_ErrorUnsupportedIndex;
            break;
    }
EXIT:
    G723_1ENC_DPRINT("%d :: Exiting GetParameter\n",__LINE__);
    G723_1ENC_DPRINT("%d :: Returning = 0x%x\n",__LINE__,eError);
    return eError;
}
/*-------------------------------------------------------------------*/
                                   ...
                                   OMX_PTR pCompParam)
{
    ...
    OMX_AUDIO_PARAM_G723TYPE *pCompG723_1Param = NULL;

        pComponentPrivate = (G723_1ENC_COMPONENT_PRIVATE *)(((OMX_COMPONENTTYPE*)hComp)->pComponentPrivate);


    G723_1ENC_DPRINT("%d :: Entering the SetParameter\n",__LINE__);
    if (pCompParam == NULL) {
        eError = OMX_ErrorBadParameter;
        G723_1ENC_DPRINT("%d :: OMX_ErrorBadParameter from SetParameter",__LINE__);
        goto EXIT;
    }
    if (pComponentPrivate->curState != OMX_StateLoaded) {
        eError = OMX_ErrorIncorrectStateOperation;
        G723_1ENC_DPRINT("%d :: OMX_ErrorIncorrectStateOperation from SetParameter",__LINE__);
        goto EXIT;
    }

    switch(nParamIndex) {
        case OMX_IndexParamAudioPortFormat:
                G723_1ENC_DPRINT("%d :: SetParameter OMX_IndexParamAudioPortFormat \n",__LINE__);
                pComponentParam = (OMX_AUDIO_PARAM_PORTFORMATTYPE *)pCompParam;
                if ( pComponentParam->nPortIndex == pComponentPrivate->pCompPort[G723_1ENC_INPUT_PORT]->pPortFormat->nPortIndex ) {
                    memcpy(pComponentPrivate->pCompPort[G723_1ENC_INPUT_PORT]->pPortFormat, pComponentParam, sizeof(OMX_AUDIO_PARAM_PORTFORMATTYPE));
                } else if ( pComponentParam->nPortIndex == pComponentPrivate->pCompPort[G723_1ENC_OUTPUT_PORT]->pPortFormat->nPortIndex ) {
                    memcpy(pComponentPrivate->pCompPort[G723_1ENC_OUTPUT_PORT]->pPortFormat, pComponentParam, sizeof(OMX_AUDIO_PARAM_PORTFORMATTYPE));
                } else {
                    G723_1ENC_DPRINT("%d :: OMX_ErrorBadPortIndex from SetParameter",__LINE__);
                    eError = OMX_ErrorBadPortIndex;
                }
            break;
        case OMX_IndexParamAudioG723:
                G723_1ENC_DPRINT("%d :: SetParameter OMX_IndexParamAudioG723_1 \n",__LINE__);
                pCompG723_1Param = (OMX_AUDIO_PARAM_G723TYPE *)pCompParam;
                if (pCompG723_1Param->nPortIndex == OMX_DirOutput) {
                    memcpy(((G723_1ENC_COMPONENT_PRIVATE *)
                            pHandle->pComponentPrivate)->G723_1Params[G723_1ENC_OUTPUT_PORT], pCompG723_1Param, sizeof(OMX_AUDIO_PARAM_G723TYPE));
                }
                else if (pCompG723_1Param->nPortIndex == OMX_DirInput) {
                    memcpy(((G723_1ENC_COMPONENT_PRIVATE *)
                            pHandle->pComponentPrivate)->G723_1Params[G723_1ENC_INPUT_PORT], pCompG723_1Param, sizeof(OMX_AUDIO_PARAM_G723TYPE));
                }
                else {
                    G723_1ENC_DPRINT("%d :: OMX_ErrorBadPortIndex from SetParameter",__LINE__);
                    eError = OMX_ErrorBadPortIndex;
        ...
        G723_1ENC_DPRINT("%d :: SetParameter OMX_IndexParamPortDefinition \n",__LINE__);
        if(((OMX_PARAM_PORTDEFINITIONTYPE *)(pCompParam))->nPortIndex == pComponentPrivate->pPortDef[G723_1ENC_INPUT_PORT]->nPortIndex) {
            G723_1ENC_DPRINT("%d :: SetParameter OMX_IndexParamPortDefinition \n",__LINE__);
            memcpy(pComponentPrivate->pPortDef[G723_1ENC_INPUT_PORT], pCompParam, sizeof(OMX_PARAM_PORTDEFINITIONTYPE));
        }
        else if(((OMX_PARAM_PORTDEFINITIONTYPE *)(pCompParam))->nPortIndex == pComponentPrivate->pPortDef[G723_1ENC_OUTPUT_PORT]->nPortIndex) {
                G723_1ENC_DPRINT("%d :: SetParameter OMX_IndexParamPortDefinition \n",__LINE__);
            memcpy(pComponentPrivate->pPortDef[G723_1ENC_OUTPUT_PORT], pCompParam, sizeof(OMX_PARAM_PORTDEFINITIONTYPE));
             }
             else {
                   G723_1ENC_DPRINT("%d :: OMX_ErrorBadPortIndex from SetParameter",__LINE__);
               eError = OMX_ErrorBadPortIndex;
            ...
            break;
        case OMX_IndexParamPriorityMgmt:
                G723_1ENC_DPRINT("%d :: SetParameter OMX_IndexParamPriorityMgmt \n",__LINE__);
                memcpy(pComponentPrivate->sPriorityMgmt, (OMX_PRIORITYMGMTTYPE*)pCompParam, sizeof(OMX_PRIORITYMGMTTYPE));
            break;

        case OMX_IndexParamAudioInit:
                G723_1ENC_DPRINT("%d :: SetParameter OMX_IndexParamAudioInit \n",__LINE__);
                memcpy(pComponentPrivate->sPortParam, (OMX_PORT_PARAM_TYPE*)pCompParam, sizeof(OMX_PORT_PARAM_TYPE));
            break;
        default:
                G723_1ENC_DPRINT("%d :: SetParameter OMX_ErrorUnsupportedIndex \n",__LINE__);
                eError = OMX_ErrorUnsupportedIndex;
            break;
    }
EXIT:
    G723_1ENC_DPRINT("%d :: Exiting SetParameter\n",__LINE__);
    G723_1ENC_DPRINT("%d :: Returning = 0x%x\n",__LINE__,eError);
    return eError;
}
                                ...
                                OMX_PTR ComponentConfigStructure)
{
    ...
    if(nConfigIndex == OMX_IndexCustomG723_1ENCStreamIDConfig){
...
EXIT:
    G723_1ENC_DPRINT("%d :: Entering GetConfig\n", __LINE__);
    G723_1ENC_DPRINT("%d :: Exiting GetConfig\n", __LINE__);
    G723_1ENC_DPRINT("%d :: Returning = 0x%x\n",__LINE__,eError);
    return eError;
}
/*-------------------------------------------------------------------*/
                                ...
                                OMX_PTR ComponentConfigStructure)
{
...
#endif        
    G723_1ENC_DPRINT("%d :: Entering SetConfig\n", __LINE__);
    if (pHandle == NULL) {
        G723_1ENC_DPRINT ("%d :: Invalid HANDLE OMX_ErrorBadParameter \n",__LINE__);
        eError = OMX_ErrorBadParameter;
        goto EXIT;
    }
    ...
    switch (nConfigIndex) {
        ...
        case OMX_IndexCustomG723_1ENCModeConfig: 
            pTiDspDefinition = (TI_OMX_DSP_DEFINITION*)ComponentConfigStructure;
            if (pTiDspDefinition == NULL) {
                eError = OMX_ErrorBadParameter;
                G723_1ENC_DPRINT("%d :: OMX_ErrorBadParameter from SetConfig\n",__LINE__);
                goto EXIT;
             }          
            ...
            break;
       case  OMX_IndexCustomG723_1ENCDataPath:
            customFlag = (OMX_S16*)ComponentConfigStructure;
            dataPath = *customFlag;            
            switch(dataPath) {
                case DATAPATH_APPLICATION:
                    G723_1ENC_DPRINT("Copying %s in to sDeviceString\n",(char*)ETEEDN_STRING_ENCODER);
        ...
        case OMX_IndexConfigAudioVolume:
            ...
            if((fdwrite=open(FIFO1,O_WRONLY))<0) {
                  G723_1ENC_DPRINT("%d :: [NBAMRE Encoder Component] - failure to open WRITE pipe\n",__LINE__);
            }
            else{
                 ...
                 {  
                     G723_1ENC_DPRINT("[G723_1 encoder] - fail to send command to audio manager\n");
                 }
                 else
                 {
                     G723_1ENC_DPRINT("[G723_1 encoder] - ok to send command to audio manager\n");
                 }
                 close(fdwrite);
          }
#endif          
...
EXIT:
    G723_1ENC_DPRINT("%d :: Exiting SetConfig\n", __LINE__);
    G723_1ENC_DPRINT("%d :: Returning = 0x%x\n",__LINE__,eError);
    return eError;
}
...
static OMX_ERRORTYPE GetState (OMX_HANDLETYPE pComponent, OMX_STATETYPE* pState)
{
    ...
    OMX_COMPONENTTYPE *pHandle = (OMX_COMPONENTTYPE *)pComponent;
    G723_1ENC_DPRINT("%d :: Entering GetState\n", __LINE__);
    if (!pState) {
        eError = OMX_ErrorBadParameter;
        G723_1ENC_DPRINT("%d :: OMX_ErrorBadParameter from GetState\n",__LINE__);
        goto EXIT;
    }

    if (pHandle && pHandle->pComponentPrivate) {
        *pState =  ((G723_1ENC_COMPONENT_PRIVATE*)
...
EXIT:
    G723_1ENC_DPRINT("%d :: Exiting GetState\n", __LINE__);
    G723_1ENC_DPRINT("%d :: Returning = 0x%x\n",__LINE__,eError);
    return eError;
}
                                      ...
                                      OMX_BUFFERHEADERTYPE* pBuffer)
{
    ...
    G723_1ENC_COMPONENT_PRIVATE *pComponentPrivate =
                         (G723_1ENC_COMPONENT_PRIVATE *)pHandle->pComponentPrivate;
    pPortDef = ((G723_1ENC_COMPONENT_PRIVATE*)pComponentPrivate)->pPortDef[G723_1ENC_INPUT_PORT];

    G723_1ENC_DPRINT("%d :: Entering EmptyThisBuffer\n", __LINE__);
    if (pBuffer == NULL) {
        eError = OMX_ErrorBadParameter;
        G723_1ENC_DPRINT("%d :: About to return OMX_ErrorBadParameter\n",__LINE__);
        goto EXIT;
    }
    ...
    if (!pPortDef->bEnabled) {
        eError  = OMX_ErrorIncorrectStateOperation;
        G723_1ENC_DPRINT("%d :: About to return OMX_ErrorIncorrectStateOperation\n",__LINE__);
        goto EXIT;
    }

    if (pBuffer->nVersion.nVersion != pComponentPrivate->nVersion) {
        eError = OMX_ErrorVersionMismatch;
        G723_1ENC_DPRINT("%d :: About to return OMX_ErrorVersionMismatch\n",__LINE__);
        goto EXIT;
    }

    if (pBuffer->nInputPortIndex != G723_1ENC_INPUT_PORT) {
        eError  = OMX_ErrorBadPortIndex;
        G723_1ENC_DPRINT("%d :: About to return OMX_ErrorBadPortIndex\n",__LINE__);
        goto EXIT;
    }
    ...
    G723_1ENC_DPRINT("----------------------------------------------------------------\n");
    G723_1ENC_DPRINT("%d :: Comp Sending Filled ip buff = %p to CompThread\n",__LINE__,pBuffer);
    G723_1ENC_DPRINT("----------------------------------------------------------------\n");
    ...
    if (ret == -1) {
        G723_1ENC_DPRINT("%d :: Error in Writing to the Data pipe\n", __LINE__);
        eError = OMX_ErrorHardware;
        goto EXIT;
    }
    pComponentPrivate->nEmptyThisBufferCount++;
EXIT:
    G723_1ENC_DPRINT("%d :: Exiting EmptyThisBuffer\n", __LINE__);
    G723_1ENC_DPRINT("%d :: Returning = 0x%x\n",__LINE__,eError);
    return eError;
}
/*-------------------------------------------------------------------*/
                                     ...
                                     OMX_BUFFERHEADERTYPE* pBuffer)
{
    ...
    G723_1ENC_COMPONENT_PRIVATE *pComponentPrivate =
                         (G723_1ENC_COMPONENT_PRIVATE *)pHandle->pComponentPrivate;
    pPortDef = ((G723_1ENC_COMPONENT_PRIVATE*)pComponentPrivate)->pPortDef[G723_1ENC_OUTPUT_PORT];
    G723_1ENC_DPRINT("%d :: Entering FillThisBuffer\n", __LINE__);
    G723_1ENC_DPRINT("------------------------------------------------------------------\n");
    G723_1ENC_DPRINT("%d :: Comp Sending Emptied op buff = %p to CompThread\n",__LINE__,pBuffer);
    G723_1ENC_DPRINT("------------------------------------------------------------------\n");
    if (pBuffer == NULL) {
        eError = OMX_ErrorBadParameter;
        G723_1ENC_DPRINT(" %d :: About to return OMX_ErrorBadParameter\n",__LINE__);
    ...
    if (pBuffer->nOutputPortIndex != G723_1ENC_OUTPUT_PORT) {
        eError  = OMX_ErrorBadPortIndex;
        G723_1ENC_DPRINT(" %d :: About to return OMX_ErrorBadPortIndex\n",__LINE__);
        goto EXIT;
    }
...
EXIT:
    G723_1ENC_DPRINT("%d :: Exiting FillThisBuffer\n", __LINE__);
    G723_1ENC_DPRINT("%d :: Returning = 0x%x\n",__LINE__,eError);
    return eError;
}
/*-------------------------------------------------------------------*/
...
static OMX_ERRORTYPE ComponentDeInit(OMX_HANDLETYPE pHandle)
{
    ...
    G723_1ENC_COMPONENT_PRIVATE *pComponentPrivate =
                         (G723_1ENC_COMPONENT_PRIVATE *)pComponent->pComponentPrivate;
    G723_1ENC_DPRINT("%d :: Entering ComponentDeInit\n", __LINE__);

#ifdef RESOURCE_MANAGER_ENABLED
    eError = RMProxy_NewSendCommand(pHandle, RMProxy_FreeResource, OMX_G723_Encoder_COMPONENT, 0, 3456,NULL);
    if (eError != OMX_ErrorNone) {
         G723_1ENC_DPRINT ("%d ::OMX_G723_1Encoder.c :: Error returned from destroy ResourceManagerProxy thread\n",
                                                        __LINE__);
    }
    eError = RMProxy_Deinitalize();
    if (eError != OMX_ErrorNone) {
         G723_1ENC_DPRINT("%d :: Error from RMProxy_Deinitalize\n",__LINE__);
         goto EXIT;
    }
#endif

    pComponentPrivate->bIsStopping = 1;
    eError = G723_1ENC_StopComponentThread(pHandle);
    if (eError != OMX_ErrorNone) {
         G723_1ENC_DPRINT("%d :: Error from G723_1ENC_StopComponentThread\n",__LINE__);
         goto EXIT;
    }
    /* Wait for thread to exit so we can get the status into "eError" */
    /* close the pipe handles */
    eError = G723_1ENC_FreeCompResources(pHandle);
    if (eError != OMX_ErrorNone) {
         G723_1ENC_DPRINT("%d :: Error from G723_1ENC_FreeCompResources\n",__LINE__);
         goto EXIT;
    }
...
EXIT:
    G723_1ENC_DPRINT("%d :: Exiting ComponentDeInit\n", __LINE__);
    G723_1ENC_DPRINT("%d :: Returning = 0x%x\n",__LINE__,eError);
    return eError;
}
                                             ...
                                             OMX_TUNNELSETUPTYPE* pTunnelSetup)
{
    ...
    G723_1ENC_DPRINT("%d :: Entering ComponentTunnelRequest\n", __LINE__);
    G723_1ENC_DPRINT("%d :: Exiting ComponentTunnelRequest\n", __LINE__);
    G723_1ENC_DPRINT("%d :: Returning = 0x%x\n",__LINE__,eError);
    return eError;
}
...

{
    ...
    pComponentPrivate = (G723_1ENC_COMPONENT_PRIVATE *)
            (((OMX_COMPONENTTYPE*)hComponent)->pComponentPrivate);

    pPortDef = ((G723_1ENC_COMPONENT_PRIVATE*)pComponentPrivate)->pPortDef[nPortIndex];
    G723_1ENC_DPRINT("%d :: Entering AllocateBuffer\n", __LINE__);
    G723_1ENC_DPRINT("%d :: pPortDef = %p\n", __LINE__,pPortDef);
    G723_1ENC_DPRINT("%d :: pPortDef->bEnabled = %d\n", __LINE__,pPortDef->bEnabled);
    ...
    if (nPortIndex == G723_1ENC_INPUT_PORT) {
        ...
        if (pComponentPrivate->pInputBufferList->numBuffers == pPortDef->nBufferCountActual) {
            ...
            G723_1ENC_DPRINT("%d :: pPortDef->bPopulated = %d\n", __LINE__, pPortDef->bPopulated);
        }
    }
    else if (nPortIndex == G723_1ENC_OUTPUT_PORT) {
    ...
    pBufferHeader->nVersion.s.nVersionMajor = G723_1ENC_MAJOR_VER;
    pBufferHeader->nVersion.s.nVersionMinor = G723_1ENC_MINOR_VER;
...
EXIT:
    G723_1ENC_DPRINT("%d :: Exiting AllocateBuffer\n",__LINE__);
    G723_1ENC_DPRINT("%d :: Returning = 0x%x\n",__LINE__,eError);
    return eError;
}
            ...
            OMX_IN  OMX_BUFFERHEADERTYPE* pBuffer)
{
    ...
    G723_1ENC_DPRINT("%d :: Entering FreeBuffer\n", __LINE__);
    for (i=0; i < G723_1ENC_MAX_NUM_OF_BUFS; i++) {
        buff = pComponentPrivate->pInputBufferList->pBufHdr[i];
        if (buff == pBuffer) {
            G723_1ENC_DPRINT("%d :: Found matching input buffer\n",__LINE__);
            G723_1ENC_DPRINT("%d :: buff = %p\n",__LINE__,buff);
            G723_1ENC_DPRINT("%d :: pBuffer = %p\n",__LINE__,pBuffer);
            inputIndex = i;
            break;
        }
        else {
            G723_1ENC_DPRINT("%d :: This is not a match\n",__LINE__);
            G723_1ENC_DPRINT("%d :: buff = %p\n",__LINE__,buff);
            G723_1ENC_DPRINT("%d :: pBuffer = %p\n",__LINE__,pBuffer);
        }
    }
    ...
    for (i=0; i < G723_1ENC_MAX_NUM_OF_BUFS; i++) {
        ...
        if (buff == pBuffer) {
            G723_1ENC_DPRINT("%d :: Found matching output buffer\n",__LINE__);
            G723_1ENC_DPRINT("%d :: buff = %p\n",__LINE__,buff);
            G723_1ENC_DPRINT("%d :: pBuffer = %p\n",__LINE__,pBuffer);
            outputIndex = i;
            break;
    ...
    if (inputIndex != -1) {
        ...
        OMX_NBMEMFREE_STRUCT(pComponentPrivate->pInputBufferList->pBufHdr[inputIndex]);
            ...
            pComponentPrivate->pPortDef[G723_1ENC_INPUT_PORT]->nBufferCountMin) {

            pComponentPrivate->pPortDef[G723_1ENC_INPUT_PORT]->bPopulated = OMX_FALSE;
            }
        if(pComponentPrivate->pPortDef[G723_1ENC_INPUT_PORT]->bEnabled &&
        ...
        if (pComponentPrivate->pOutputBufferList->numBuffers <
            pComponentPrivate->pPortDef[G723_1ENC_OUTPUT_PORT]->nBufferCountMin) {
            pComponentPrivate->pPortDef[G723_1ENC_OUTPUT_PORT]->bPopulated = OMX_FALSE;
        }
        if(pComponentPrivate->pPortDef[G723_1ENC_OUTPUT_PORT]->bEnabled &&
            (pComponentPrivate->curState == OMX_StateIdle ||
            pComponentPrivate->curState == OMX_StateExecuting ||
            pComponentPrivate->curState == OMX_StatePause)) {
            pComponentPrivate->cbInfo.EventHandler( pHandle,
        ...
        G723_1ENC_DPRINT("%d :: Returning OMX_ErrorBadParameter\n",__LINE__);
        eError = OMX_ErrorBadParameter;
    }
       if ((!pComponentPrivate->pInputBufferList->numBuffers &&
            !pComponentPrivate->pOutputBufferList->numBuffers) &&
    ...
    G723_1ENC_DPRINT("%d :: Exiting FreeBuffer\n", __LINE__);
    G723_1ENC_DPRINT("%d :: Returning = 0x%x\n",__LINE__,eError);
    return eError;
}
            ...
            OMX_IN OMX_U8* pBuffer)
{
    ...
    pPortDef = ((G723_1ENC_COMPONENT_PRIVATE*)pComponentPrivate)->pPortDef[nPortIndex];
    G723_1ENC_DPRINT("%d :: Entering UseBuffer\n", __LINE__);
    G723_1ENC_DPRINT("%d :: pPortDef->bPopulated = %d \n",__LINE__,pPortDef->bPopulated);
    ...
    if (nPortIndex == G723_1ENC_OUTPUT_PORT) {
        pBufferHeader->nInputPortIndex = -1;
        pBufferHeader->nOutputPortIndex = nPortIndex;
        pComponentPrivate->pOutputBufferList->pBufHdr[pComponentPrivate->pOutputBufferList->numBuffers] = pBufferHeader;
        pComponentPrivate->pOutputBufferList->bBufferPending[pComponentPrivate->pOutputBufferList->numBuffers] = 0;
...
EXIT:
    G723_1ENC_DPRINT("%d :: Exiting UseBuffer\n", __LINE__);
    G723_1ENC_DPRINT("%d :: Returning = 0x%x\n",__LINE__,eError);
    return eError;
}
            ...
            OMX_OUT OMX_INDEXTYPE* pIndexType) 
{
    ...
    G723_1ENC_DPRINT("GetExtensionIndex\n");
    if (!(strcmp(cParameterName,"OMX.TI.index.config.tispecific"))) {
        *pIndexType = OMX_IndexCustomG723_1ENCModeConfig;
        G723_1ENC_DPRINT("OMX_IndexCustomG723_1ENCModeConfig\n");
    }
    else if (!(strcmp(cParameterName,"OMX.TI.index.config.g723_1.streamIDinfo"))) {
        *pIndexType = OMX_IndexCustomG723_1ENCStreamIDConfig;
        G723_1ENC_DPRINT("OMX.TI.index.config.g723_1.streamIDinfo\n");
    }
    else if (!(strcmp(cParameterName,"OMX.TI.index.config.G723_1.datapath"))) {
        *pIndexType = OMX_IndexCustomG723_1ENCDataPath;
        G723_1ENC_DPRINT("OMX.TI.index.config.G723_1.datapath\n");
    }
    else {
        eError = OMX_ErrorBadParameter;
    }

    G723_1ENC_DPRINT("Exiting GetExtensionIndex\n");
    return eError;
}
      ...
      OMX_IN OMX_U32 nIndex)
{
    ...
    OMX_ERRORTYPE eError = OMX_ErrorNone;
    pComponentPrivate = (G723_1ENC_COMPONENT_PRIVATE *)(((OMX_COMPONENTTYPE*)hComponent)->pComponentPrivate);

    if(nIndex == 0){
      memcpy(cRole, &pComponentPrivate->componentRole.cRole, sizeof(OMX_U8) * OMX_MAX_STRINGNAME_SIZE); 
      G723_1ENC_DPRINT("::::In ComponenetRoleEnum: cRole is set to %s\n",cRole);
    }
    else {
      eError = OMX_ErrorNoMore;
        }
