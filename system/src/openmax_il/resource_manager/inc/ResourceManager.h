...
#undef RM_DEBUG 
#ifdef  RM_DEBUG
        #define RM_DPRINT(...)    fprintf(stdout,__VA_ARGS__)
#else
        #define RM_DPRINT(...)
#endif
...
#define RM_OPERATING_POINT_2_MHZ 180

#define RM_OPERATING_POINT_3 3
#define RM_OPERATING_POINT_3_MHZ 360

#define RM_OPERATING_POINT_4 4
#define RM_OPERATING_POINT_4_MHZ 400

#define RM_OPERATING_POINT_5 5
#define RM_OPERATING_POINT_5_MHZ 430
