<<<<<<< HEAD:video/src/openmax_il/video_decode/inc/OMX_VideoDec_Utils.h
...
#define VIDDEC_FACTORFORMAT420                  (3 >> 1)
 ...
 */
...
#if 0
    #define VIDDEC_BUFFERPRINT_DEBUG
    #define VIDDEC_PRINT_DEBUG
    #define VIDDEC_VERSIONPRINT_DEBUG
#endif
    ...
    #include <oaf_debug.h>
        ...
        #define VIDDEC_DPRINT
    #endif
    #ifndef VIDDECODER_DPRINT
        #define VIDDECODER_DPRINT
    #endif
    #ifndef VIDDEC_EPRINT
        #define VIDDEC_EPRINT
    #endif
    #ifndef VIDDECODER_EPRINT
        #define VIDDECODER_EPRINT
    #endif
    #ifndef OMX_DPRINT
        #define OMX_DPRINT
    #endif
    #ifndef OMX_BUFFERPRINT
        #define OMX_BUFFERPRINT
    #endif
    #ifndef VIDDEC_BUFFERPRINT
        #define VIDDEC_BUFFERPRINT
    #endif
    #ifndef VIDDEC_VERSIONPRINT
       ...
       #define VIDDEC_EPRINT(STR, ARG...)     VIDDEC_eprint(__LINE__, __FUNCTION__, STR, ##ARG)
    #else
        #define VIDDECODER_EPRINT(...)
        #define VIDDEC_EPRINT(...)
    #endif
        ...
        #define VIDDECODER_DPRINT(...)
            ...
            #define VIDDEC_BUFFERPRINT(...)
        #endif
        #ifndef VIDDEC_VERSIONPRINT_DEBUG
            #define VIDDEC_VERSIONPRINT(...)
        #endif
        #ifndef VIDDEC_DPRINT
                #define VIDDEC_DPRINT(...)
...
#define VIDDEC_COLORFORMAT422               OMX_COLOR_FormatCbYCrY
#define VIDDEC_COLORFORMAT420               OMX_COLOR_FormatYUV420PackedPlanar
#define VIDDEC_COLORFORMATUNUSED            OMX_COLOR_FormatUnused
...
#define VIDDEC_DEFAULT_INPUT_BUFFER_SIZE        202752
#define VIDDEC_DEFAULT_OUTPUT_BUFFER_SIZE       202752
#define VIDDEC_DEFAULT_WIDTH                    352
#define VIDDEC_DEFAULT_HEIGHT                   288
#define VIDDEC_INPUT_PORT_COMPRESSIONFORMAT     OMX_VIDEO_CodingMPEG4
#define VIDDEC_OUTPUT_PORT_COMPRESSIONFORMAT    OMX_VIDEO_CodingUnused
#define VIDDEC_INPUT_PORT_BUFFERSUPPLIER        VIDDEC_ZERO
#define VIDDEC_OUTPUT_PORT_BUFFERSUPPLIER       VIDDEC_ZERO
...
#endif
#endif
>>>>>>> 43dbe6e78591689dd0f2a6cc9fb18e439aa507c9:video/src/openmax_il/video_decode/inc/OMX_VideoDec_Utils.h
